...
# 📖 Learn Web Development <a name="about-project"></a>

**Learn Web Development** is about courses related to the Web Development.
...
```sh
  cd my-folder
  git clone https://github.com/MAleemH/capstone-project.git
```
-
...
Feel free to check the [issues page](https://github.com/MAleemH/capstone-project/issues).
...
Original design idea by [Cindy Shin in Behance](https://www.behance.net/adagio07). And the licencse to use is [Creative Commons license of the design](https://creativecommons.org/licenses/by-nc/4.0/).
